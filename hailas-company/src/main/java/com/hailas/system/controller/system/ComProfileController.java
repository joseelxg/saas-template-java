...
import com.hailas.framework.web.service.TokenService;
...
public class ComProfileController extends BaseController
{
    @Autowired
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws IOException
    {
        ...
        {
            LoginUser loginUser = getLoginUser();
            String avatar = FileUploadUtils.upload(HailasConfig.getAvatarPath(), file);
