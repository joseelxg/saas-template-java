...
public interface ComMenuMapper
{
     ...
     * @return 菜单列表
     */
    public List<SysMenu> selectMenuTreeAll(Long companyId);
     ...
     * @return 菜单列表
     */
    public List<SysMenu> selectMenuTreeByUserId(@Param("userId") Long userId,@Param("companyId") Long companyId);
