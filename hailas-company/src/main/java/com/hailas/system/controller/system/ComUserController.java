...
public class ComUserController extends BaseController
{
    ...
    @Autowired
    private IComRoleService roleService;

    @Autowired
    private IComPostService postService;
    ...
    public AjaxResult getInfo(@PathVariable(value = "userId", required = false) Long userId)
    {
        ...
        ajax.put("roles", SysUser.isAdmin(getLoginUser().getUser()) ? roles : roles.stream().filter(r -> !r.isAdmin()).collect(Collectors.toList()));
