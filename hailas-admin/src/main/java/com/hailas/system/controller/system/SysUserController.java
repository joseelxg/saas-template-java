...
import com.hailas.system.service.ISysPostService;
import com.hailas.system.service.ISysRoleService;
import com.hailas.system.service.ISysUserService;
...
public class SysUserController extends BaseController
{
    ...
    public AjaxResult getInfo(@PathVariable(value = "userId", required = false) Long userId)
    {
        ...
        ajax.put("roles", SysUser.isAdmin(user) ? roles : roles.stream().filter(r -> !r.isAdmin()).collect(Collectors.toList()));
