package com.hailas.framework.security.handle;

import com.alibaba.fastjson.JSON;
import com.hailas.common.constant.Constants;
import com.hailas.common.constant.HttpStatus;
...
public class LogoutSuccessHandlerImpl implements LogoutSuccessHandler
{
            ...
            throws IOException, ServletException
    {
        ...
        if (StringUtils.isNotNull(loginUser))
        {
            ...
            // 记录用户退出日志
            AsyncManager.me().execute(AsyncFactory.recordLogininfor(userName, Constants.LOGOUT, "退出成功", loginUser.getCompanyId()));
        }
