package com.hailas.system.controller.monitor;
...
import com.hailas.common.core.domain.entity.SysUserOnline;
import com.hailas.system.service.IComUserOnlineService;
...
public class ComUserOnlineController extends BaseController
{
    @Autowired
    private IComUserOnlineService userOnlineService;
    ...
    {
        Collection<String> keys = redisCache.keys(Constants.LOGIN_COMPANY_TOKEN_KEY + "*");
    ...
    {
        redisCache.deleteObject(Constants.LOGIN_COMPANY_TOKEN_KEY + tokenId);
