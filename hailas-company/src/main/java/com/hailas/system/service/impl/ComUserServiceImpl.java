...
import com.hailas.common.core.domain.entity.SysPost;
import com.hailas.common.core.domain.entity.SysUserPost;
import com.hailas.common.core.domain.entity.SysUserRole;
import com.hailas.system.mapper.*;
...
{
    private static final Logger log = LoggerFactory.getLogger(ComUserServiceImpl.class);
    ...
    @Autowired
    private ComPostMapper postMapper;

    @Autowired
    private ComUserRoleMapper userRoleMapper;

    @Autowired
    private ComUserPostMapper userPostMapper;

    @Autowired
    private ISysConfigService configService;

    @Autowired
    ComDeptMapper deptMapper;
    ...
    public int updateUser(SysUser user)
    {
        ...
        {
            user.setCompanyId(Long.parseLong(dept.getAncestors().split(",")[1]));
        }
