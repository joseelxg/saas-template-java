...
import com.hailas.common.annotation.Excel.Type;
...
public class SysUser extends BaseEntity
{
    ...
    private List<CompanyDevice> companyDivices;
    ...
    {
        return (user.userId != null && 1L == user.userId)||user.getIsCompanyAdmin()== Integer.valueOf(1);
    }
